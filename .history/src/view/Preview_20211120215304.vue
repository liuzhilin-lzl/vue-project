<!--
 * @Author: your name
 * @Date: 2021-10-28 11:16:55
 * @LastEditTime: 2021-11-20 21:52:34
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /vue-project/src/view/Preview.vue
-->
<template>
	<div>
		...
		<inputModal v-model='text' :isModel="true"></inputModal>
		<div>
		.sync 修饰符双向绑定
		</div>
		<inputModal :changeValue.sync='changeText' :isModel="false"></inputModal>
