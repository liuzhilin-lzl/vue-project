 ...
 * @LastEditTime: 2021-11-09 16:34:20
...
<template>
	<div class="tinymce-editor">
		...
		<divclass="box-main-item"
			v-for="(doc, subIndex) in item.docList"
			:key="subIndex"
			:ref="divs">
			<div class="box-main-item-left">
				<img :src="require(`../../../../assets/img/icon-svg/${doc.type}.svg`)"alt=""/>
				<span ref="renameRef">{{ doc.courseName }}</span>
			</div>
			<div
				v-if="doc.type == 'py'"
				class="box-main-item-right-download"
			></div>
			<div v-else class="box-main-item-right-check"></div>
		</divclass=>
	</div>
</template>
<script>
